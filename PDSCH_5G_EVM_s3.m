...
nrtm = "NR-FR1-TM3.1"; % Reference channel(NR-TM or FRC)
...
%% RF model from the budget analyzer
rfTransmitter=rfsystem(rfb)
rfTransmitter.SampleTime = 1/(tmwaveinfo.Info.SampleRate*5)
